...
namespace giac {
  ...
  */
  ...
  gen normal_inequation(const gen & e,GIAC_CONTEXT){
  ...
  static const char _normal_inequation_s []="normal_inequation";
  static define_unary_function_eval (__normal_inequation,normal_inequation,_normal_inequation_s);
  define_unary_function_ptr5( at_normal_inequation ,alias_at_normal_inequation,&__normal_inequation,0,true);
