...
#define __GMP_CFLAGS "-target x86_64-apple-ios14.0-macabi -miphoneos-version-min=14.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -arch x86_64"
