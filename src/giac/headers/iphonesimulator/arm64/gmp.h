...
#define __GMP_CFLAGS "-target arm64-apple-ios9.0-simulator -miphoneos-version-min=9.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator18.2.sdk -arch arm64"
